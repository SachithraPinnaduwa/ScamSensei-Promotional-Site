      ...
      <div className="mr-auto place-self-center lg:col-span-7">
        ...
        <div className="flex  mb-8 gap-4 md:flex-row  justify-center flex-col">
          <Link to={"/faq"}>
                 ...
                 <a  style={{ width: '200px' }} className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:text-white dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" target="_blank" href="https://www.youtube.com/watch?v=YnwOU6qHQHI">
