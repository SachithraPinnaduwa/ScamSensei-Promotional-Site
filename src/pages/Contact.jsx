  ...
  useEffect(() => {
    const submitForm = async () => {
      ...
      try {
        ...
        // Handle error response (e.g., showing an error message)
      }
    ...
    if (isSubmitting && auth.proceed) {
      submitForm();
    }
  }, [isSubmitting, auth.proceed, email, message, subject]);

  const handleSubmit = (e) => {
    e.preventDefault();
    auth.setIsPrivacyModalOpen(true);
    setIsSubmitting(true); // Set the flag to indicate a submission attempt
  };
